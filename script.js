...
// - Fill in apiKey, authDomain, projectId, storageBucket, messagingSenderId, appId
...
// Real-time listener for shared_files
...
// ---------- Calendar (FullCalendar) with real storage & color-coding ----------
...
// Theme changes saved to Firestore so all clients sync
...
// Live wallpaper selects (both UI select and settings)
...
// wallpaper upload: save to Storage then record URL in settings/ui doc
...
// settings panel wallpaper upload too
...
function setWallpaperUrl(url) {
  ...
  // if custom wallpaper present, hide live layer to avoid clash
  liveLayer.style.display = 'none';
}

// ---------- Listen to shared UI settings from Firestore ----------
...
// ---------- Settings: initial load (fallback) ----------
...
// ---------- Basic auto-refresh button ----------
document.getElementById('refreshBtn').addEventListener('click', () => location.reload());

// ---------- Extra: small keyboard helper to close modals (esc) ----------
